...
const CloudAppraisalForm = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    console.log(data);
    axiosAPI.post('http://localhost:4000/clouds', data)
      ...
      <div className="page-content">
        ...
        <Row>
          <Col>
            <Card>
              <CardBody>
                <CardTitle className="h4">Cloud Trainer Appraisal Form</CardTitle>
                <form onSubmit={handleFormSubmit}>
                  <Row className="mb-3">
                    ...
                    >
                      Multi Cloud trainings delivery
                    </label>
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                      Strong knowledge on Multiple cloud platforms
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                      Should be Authorized & Certified instructor
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Technology integration into development and office related activities
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
...
export default CloudAppraisalForm;