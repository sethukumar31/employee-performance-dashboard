...
const ManagerAppraisalForm = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    console.log(data);
    axiosAPI.post('http://localhost:4000/managers', data)
      ...
      <div className="page-content">
        ...
        <Row>
          <Col>
            <Card>
              <CardBody>
                <CardTitle className="h4">Manager Appraisal Form</CardTitle>
                <form onSubmit={handleFormSubmit}>
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                      Conduct Beginning of Shift meetings with team
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Manager level approvals to team
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Providingnecessary productive tasks to team
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Skill upgrade of the team members
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Making sure the program is free of vulnerabilities
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                    Team appraisal recommendations
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
