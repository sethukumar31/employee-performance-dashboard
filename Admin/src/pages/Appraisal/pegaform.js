...
const PegaForm = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    console.log(data);
    axiosAPI.post('http://localhost:4000/pegas', data)
      ...
      <div className="page-content">
        ...
        <Row>
          <Col>
            <Card>
              <CardBody>
                <CardTitle className="h4">Pega Trainer Appraisal Form</CardTitle>
                <form onSubmit={handleFormSubmit}>
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                      Strong knowledge on PEGA and related tools
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
                  ...
                  <Row className="mb-3">
                    <label
                      ...
                      className="col-md-2 col-form-label"
                    >
                     Knowledge of PEGA integration into multi cloud
                    </label>
                    <div className="col-md-10">
                      <input
                        className="form-control"
