...
const DevopsTrainerStatus = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axiosAPI.get("http://localhost:4000/getdevopss");
  ...
  const data = {
    columns: [
      ...
      { label: "DevOps trainings delivery", field: "objective1", sort: "asc", width: 200 },
      { label: "Strong knowledge on DevOps major tools", field: "objective2", sort: "asc", width: 200 },
      { label: "Knowledge of DevOps integration into multi cloud", field: "objective3", sort: "asc", width: 200 },
      { label: "Authorized & Certified instructor", field: "objective4", sort: "asc", width: 200 },
...
export default DevopsTrainerStatus;