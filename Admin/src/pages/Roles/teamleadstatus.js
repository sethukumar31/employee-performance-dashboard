...
const TeamLeadStatus = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axiosAPI.get("http://localhost:4000/getteamleads");
  ...
  const data = {
    columns: [
      ...
      { label: "Work with Program Managers", field: "objective1", sort: "asc", width: 200 },
      { label: "Track team work progress", field: "objective2", sort: "asc", width: 200 },
      { label: "Provide necessary productive tasks", field: "objective3", sort: "asc", width: 200 },
      { label: "Lead level approvals to team", field: "objective4", sort: "asc", width: 200 },
